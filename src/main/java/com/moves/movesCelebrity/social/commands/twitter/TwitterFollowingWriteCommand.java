...
public class TwitterFollowingWriteCommand implements Command<Void, ArrayList<Document>> {
...
//        s3Service.upload("doc1.json","dex.sm-scraper", documents.get(0));
        SocialMediaPostDao.insertMany(documents, MovesAppConfiguration.COLLECTION_FOLLOWING_TWITTER);
    }
}
